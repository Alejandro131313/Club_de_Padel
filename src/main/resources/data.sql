insert into Equipo (id_equipo, Premios, Nombre_equipo) values (1, 2, 'Los Matados');
...
insert into Torneo (Fecha,Premio) values ('2024-10-10', 500.00);
insert into Torneo (Fecha,Premio) values ('2022-5-10', 1500.00);
